...
const Admin = () => {
  ...
  return (
    <div className="min-h-screen bg-[#212121] text-white p-8">
      <Link
        to="/"
        className="text-white bg-green-500 font-bold py-2 px-4 rounded-full"
      >
        Go to home page
      </Link>
      ...
      >
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium mb-1">Thumnail</label>
          <input
            type="file"
            className="auth-input"
            accept="image/*"
          ...
          {songs &&
            songs.map((e, i) => (
              <div key={i} className="bg-[#181818] p-4 rounded-lg shadow-md">
                ...
                <h4 className="text-sm text-gray-500">{e.descripiton}</h4>
